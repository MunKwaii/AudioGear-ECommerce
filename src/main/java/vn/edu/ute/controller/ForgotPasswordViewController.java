...
/**
 * Controller chuyên điều hướng hiển thị trang Quên Mật Khẩu
 */
@WebServlet("/forgot-password")
public class ForgotPasswordViewController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        // Trả về file forgot-password.html
        templateEngine.process("forgot-password", context, resp.getWriter());
    }
}
